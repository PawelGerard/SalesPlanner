public class ReportTableRecord {
    ...
    String valueC1, valueC2, valueC3, valueC4, valueC5, valueC6;

    public ReportTableRecord(String valueC1, String valueC2, String valueC3, String valueC4, String valueC5, String valueC6) {
    ...
    public void setValueC6(String calueC6) {
        this.valueC6 = calueC6;
    }
}
